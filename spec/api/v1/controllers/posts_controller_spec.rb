...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "unauthenticated user" do
    ...
    it "PUT update returns http unauthenticated" do
      put :update, id: my_post.id, post: {title: "Post Title", body: "Post Body: generic and 20", user: my_user}
      expect(response).to have_http_status(401)
    end

    it "POST create returns http unauthenticated" do
      post :create, id: my_topic.id, post: {title: "Post Title", body: "Post Body: generic and 20", user: my_user}
      expect(response).to have_http_status(401)
    end
  ...
  context "authenticated and authorized users" do
    ...
    describe "PUT update" do
      before { put :update, id: my_post.id, post: {name: @new_post.title, body: @new_post.body, user: @new_post.user} }
    ...
    describe "POST create" do
      before { post :create, topic_id: my_topic.id, post: {title: @new_post.title, body: @new_post.body, user: @new_post.user} }
