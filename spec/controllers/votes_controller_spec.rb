...
RSpec.describe VotesController, type: :controller do
  let(:my_user) { User.create!(name: "Bloccit User", email: "user@bloccit.come", password: "helloworld") }
  ...
  context "guest" do
    describe "POST up_vote" do
      it "should redirect the user to the sign in view" do
  ...
  context "signed in user" do
    ...
    describe "POST up_vote" do
      ...
      it "should increase the sum of post votes by one" do
    ...
    describe "POST down_vote" do
      ...
      it "should decrease the sum of post votes by one" do
        points = user_post.points
        post :down_vote, post_id: user_post.id
        expect(user_post.points).to eq(points - 1)
      end
